...
public class MBase64 {
	...
	public static void main(String[] args) {
		...
		// encode
		byte[] encodeBytes = MBase64.encode(data.getBytes());
		String encodeStr = "";
		try {
		...
		System.out.println("data encode result= " + encodeStr);

		// decode
		String decodeStr = "";
		try {
			byte[] decodeBytes = MBase64.decode(encodeStr);
			decodeStr = new String(decodeBytes, "UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
		}

		System.out.println("data decode result= " + decodeStr);
	}
